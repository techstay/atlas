...
![](./attachments/nes-controller-config.avif)

如果同时使用手柄和键盘的话，也可以点击左下角的设置 2，分配第二套配置，这两套配置可以同时生效。

![](./attachments/nes-controller-config2.avif)
...
![](./attachments/nes-quality-compare.avif)
...
![](./attachments/nes-goldfinger.avif)
...
![](./attachments/nes-network-coop.avif)
