...
- 火山引擎 CodingPlan — 字节跳动旗下 Coding Plan 服务，提供针对编程场景优化的模型配置。支持 Anthropic 和 OpenAI 两种接口协议，模型列表丰富，适合编程辅助和代码生成场景。
  ...
  - **API Key**: `ARK_API_KEY`
  - **Model**: `doubao-seed-code`, `doubao-seed-2.0-code`, `doubao-seed-2.0-pro`, `doubao-seed-2.0-lite`, `minimax-m2.7`, `glm-5.1`, `kimi-k2.6`, `deepseek-v4-pro`, `deepseek-v4-flash`, `minimax-m3`
...
- **[阶跃星辰](https://platform.stepfun.com)** — 国产大模型厂商，Step 系列多模态大模型在图像理解、长上下文等方向表现突出。
  - **Base URL (Anthropic)**: `https://api.stepfun.com/step_plan`
  - **Base URL (OpenAI)**: `https://api.stepfun.com/step_plan/v1`
